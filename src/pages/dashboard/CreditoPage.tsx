    ...
    <div className="full-width-padding">
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#2c347c] mb-4">Crédito</h2>
            <p className="text-gray-700 mb-6">
              Es la operación final en una transferencia y se encuentra detallado en el flujo de la
              operación de transferencia desde la entidad hacia Coonecta. El crédito transfiere los
              fondos debitados de la cuenta del usuario a la cuenta del beneficiario, siendo la
              operación final en una transferencia.
            </p>
            <div className="container-centered">
              <img
                src={ReversoCreditoImage}
                alt="Proceso de Crédito"
                ...
                <table className="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>24</td>
                      <td>Si</td>
                      <td>Llave única del usuario debitado</td>
                    ...
                    <tr>
                      ...
                      <td>DURÁN DE LA ROSA ESTEBAN</td>
                      <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>24</td>
                      <td>SI</td>
                      <td>Llave única del usuario acreditado</td>
                    ...
                    <tr>
                      ...
                      <td>10</td>
                      <td>No</td>
                      <td>Fecha contable del switch central (Coonecta)</td>
                      <td>20/1/2025</td>
                      <td>YYYY-MM-DD</td>
                    </tr>
                  </tbody>
